	...
	<div class="row">
		<div class="col-lg-12 mx-auto">
			<div class="btn-toolbar">
				...
				<button type="button" class="btn btn-warning mr-1 mb-1" data-link="signup">Signup</button>
...
The link is 15 min valid. The user can set a new password. After 15 min old invalid users will be delete.			</p>
	<form method="POST" action="" class="paramset signup" style="">
		<input type="hidden" name="module" value="signup">
		<div class="card mb-3 border-info">
			<div class="card-header">POST</div>
			<div class="card-body">
				<div class="form-group">
					<label for="signup_post_email">email:</label>
					<input type="text" class="form-control" value="" placeholder="The email for receiving request token (string)" id="signup_post_email" name="email">
				</div>
								<div class="form-group">
					<label for="signup_post_password">password:</label>
					<input type="text" class="form-control" value="" placeholder="The password (string)" id="signup_post_password" name="password">
				</div>
								<div class="form-group">
					<label for="signup_post_password2">password2:</label>
					<input type="text" class="form-control" value="" placeholder="The password confirmation (string)" id="signup_post_password2" name="password2">
				</div>
				<div class="form-check">
					<input type="checkbox" class="form-check-input" id="signup_post_dataprotection">
					<label class="form-check-label" for="signup_post_dataprotection" name="dataProtection">dataProtection</label>
				</div>
				<div class="form-check">
					<input type="checkbox" class="form-check-input" id="signup_post_termsofservice">
					<label class="form-check-label" for="signup_post_termsofservice" name="termsOfService">termsOfService</label>
				</div>
